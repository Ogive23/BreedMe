import 'package:breed_me/Models/User.dart';
...
class SessionManager {
  ...
  void addDummyData() {
    this.user = new User('1234', 'Mahmoued Mohamed', 'Mahmoued', 'mahmouedmartin222@yahoo.com', 'male', '+201146284953', '26 El Gesr elbrany St, Dar Elsalam, Cairo - Egypt', 'https://m.economictimes.com/thumb/msid-72360263,width-1200,height-900,resizemode-4,imgsize-436664/joaquin-phoenix-recently-appeared-in-petas-we-are-all-animals-billboards-in-times-square-and-on-sunset-billboard-as-he-promoted-legislation-to-ban-travelling-wild-animal-circuses-.jpg', true, 'oauthToken');
  }
}
